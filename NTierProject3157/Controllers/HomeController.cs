...
namespace NTierProject3157.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Login(AppUser appUser)
        {
            ...
            if (appUser.Password == decrypted && yakalanan.Role == Project.ENTITIES.Enums.UserRole.Admin)
            {
            ...
            else if (yakalanan.Role == Project.ENTITIES.Enums.UserRole.Member && appUser.Password == decrypted)
            {
                if (!yakalanan.Active) return AktifKontrol();
